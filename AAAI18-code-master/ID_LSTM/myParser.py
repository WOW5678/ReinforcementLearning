...
class Parser(object):
    def getParser(self):
        ...
        parser.add_argument('--fasttest', type=int, default=1, choices=[0, 1])
        ...
        parser.add_argument('--word_vector', type=str, default='../WordVector/word2vec.txt')
        parser.add_argument('--dim', type=int, default=300)
        # 限制因子 是为了平滑policy 参数的更新
